...
public class MeepMeepTestingJokubas {
    public static void main(String[] args) {
        ...
        RoadRunnerBotEntity myBot = new DefaultBotBuilder(meepMeep)
                ...
                .followTrajectorySequence(drive -> drive.trajectorySequenceBuilder(new Pose2d(-60, -53, Math.toRadians(83)))
...
//                        .splineToSplineHeading(new Pose2d(43,-30,Math.toRadians(110)),Math.toRadians(90))
...
//                        .splineToSplineHeading(new Pose2d(50,-30,Math.toRadians(110)),Math.toRadians(90))
...
////                        .lineToLinearHeading(new Pose2d(55, -50, Math.toRadians(90)))
                        .lineToLinearHeading(new Pose2d(-58.5, -52, Math.toRadians(105)))//115)))
                        .waitSeconds(0.3)
                        .lineToLinearHeading(new Pose2d(-59, -56, Math.toRadians(80)))
                        .build());
