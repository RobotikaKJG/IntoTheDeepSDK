...
public class SlidesClosed implements Action {
    private boolean initialized = false;
    private final SlideLogic outtakeSlideLogic;

    public SlidesClosed(SlideLogic outtakeSlideLogic) {
    ...
    private boolean isExtending() {
        return Math.abs(outtakeSlideLogic.getSlidePosition()) > OuttakeConstants.slideTargetThreshold;
    }
}
