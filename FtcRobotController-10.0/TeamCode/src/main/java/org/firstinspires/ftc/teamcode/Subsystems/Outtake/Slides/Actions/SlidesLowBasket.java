...
public class SlidesLowBasket implements Action {
    private boolean initialized = false;
    private final SlideLogic outtakeSlideLogic;

    public SlidesLowBasket(SlideLogic outtakeSlideLogic) {
    ...
    private boolean isExtending() {
        return Math.abs(outtakeSlideLogic.getSlidePosition() - OuttakeConstants.lowBasketPos) > OuttakeConstants.slideTargetThreshold;
    }
}
