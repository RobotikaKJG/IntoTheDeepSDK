    ...
    private void updateStates() {
        switch (OuttakeStates.getSpecimenClawState()) {
            case closed:
                ...
                break;
            case freeMove:
                servoControl.setServoPos(ServoConstants.specimenClaw, OuttakeConstants.specimenClawServoFreeMovePos);
                break;
            case halfOpen:
                servoControl.setServoPos(ServoConstants.specimenClaw, OuttakeConstants.specimenClawServoReleasePos);
                break;
            case fullyOpen:
