...
public class IntakeConstants {
    ...
    public static int ArmClearsIntakeExtension = 500;
    public static int slideTargetThreshold = 20;
    ...
    public static final int extendoMaxExtension = 1700;
    public static final int extendoSampleExtension = 380;
    public static int extendoSpecimenExtension = 480;
    public static final int extendoMinExtension = 500;
    public static final int extendoThreshold = 20;

    public static final double servoSpeed = 1;

    public static final double intakeServoMaxPos = 0.7;     // up 0.7
    public static final double intakeServoSubPos = 0.5;     // middle 0.5
    public static final double intakeServoMinPos = 0.15;     // down 0.15
    ...
    public static final double pivotWaitTime = 0.5;
