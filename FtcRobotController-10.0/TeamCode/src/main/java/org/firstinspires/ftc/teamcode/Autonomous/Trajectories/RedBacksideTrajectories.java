...
public class RedBacksideTrajectories implements BacksideTrajectories {
    ...
    public RedBacksideTrajectories(SampleMecanumDrive drive, PropPos propPos) {
        this.drive = drive;
        fillVariables();
    ...
    private void fillVariables() {
        ...
        goToProp = new TrajectorySequence[]{
                drive.trajectorySequenceBuilder(startPose)
                        .lineToSplineHeading(new Pose2d(AutonPositions.RedBacksideGoToProp0x, AutonPositions.RedBacksideGoToProp0y, Math.toRadians(180)))
                        .lineToSplineHeading(new Pose2d(AutonPositions.RedBacksideGoToProp01x, AutonPositions.RedBacksideGoToProp01y, Math.toRadians(180)))
                        .build(),

                drive.trajectorySequenceBuilder(startPose)
                        .lineToSplineHeading(new Pose2d(AutonPositions.RedBacksideGoToProp1x, AutonPositions.RedBacksideGoToProp1y, Math.toRadians(180)))
                        .build(),

                drive.trajectorySequenceBuilder(startPose)
                        //go to pixel
                        .lineToSplineHeading(new Pose2d(AutonPositions.RedBacksideGoToProp2x, AutonPositions.RedBacksideGoToProp2y, Math.toRadians(180)))
                        .build()
        };
        ...
        parkBackstage = new TrajectorySequence[]{
                drive.trajectorySequenceBuilder(goToYellowPixelPlacement[0].end())
                        .lineToConstantHeading(new Vector2d(41, -29))
